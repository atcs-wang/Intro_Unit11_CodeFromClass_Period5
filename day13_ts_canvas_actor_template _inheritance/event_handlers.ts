...
window.addEventListener("load", function() {
    ...
    // Easy #2
    actorList.addActor(new FastActor( canvas.width * 3 / 4 , canvas.height / 4));
    actorList.addActor(new BigActor( canvas.width / 4 , canvas.height * 3 / 4));
    actorList.addActor(new WrapActor( 100 , 100));
    actorList.addActor(new GreenActor( 200, 300));
    actorList.addActor(new PurpleActor( 300,200));
    actorList.addActor(new OrangeActor( 400,400));
